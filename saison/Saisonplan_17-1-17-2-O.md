...
## Einordnung
- Ambitionierte Gruppe, Stufe Grün – Großfeld + Grünball ab T1; Topspin meist G(→F)
- **Zwei Plätze parallel** (Pascal/Platz 17-1, Ben/Platz 17-2), bereits seit T1 für Match-Anteile (Einzel + Doppel) kombiniert
- Schwerpunkt: **Beinarbeit + Schlagvor-/nachbereitung, Schlagsicherheit unter Druck, Wettkampf→Taktik einstreuen**
- 17-2-O (Jonathan, Noam) hat höheren Match-Anteil als Standardgruppen; 17-1-O breiter im Niveau (Elias jung/++, Finn älter)
- Henry Plier trainiert zusätzlich samstags in 12-E-O (individuelle Vertiefung, eng abgestimmt)

## Standortbestimmung (Saisonstart)
> Phasen: G Grobform · F Feinform · S Stabilisierung · (→) im Übergang · – noch kein Thema.
> Hinweis: 7 Zieltechnik-Spalten (Topspin VH/RH getrennt), da Einstieg aus Orange zwei Stufen überbrückt. Ursprünglich getrennt erhoben (beide T1 08.05.2026), hier zusammengeführt.

**Erhoben:** T1, 08.05.2026 · **Methode:** Freies Spiel + Beobachtung (Großfeld-Einstieg)

| Kind | Platz | Topspin VH | Topspin RH | Aufschlag-Platzierung | Cross/Longline | Slice RH | Return aktiv | Beinarbeit Großfeld | Abgeleiteter Schwerpunkt |
|---|---|---|---|---|---|---|---|---|---|
| Elias Ayas (2016) | 17-1 | G *(Technikfehler)* | G(→F) | G | G | – | – | G | jung; VH-Technikfehler (oben→unten) → Niedrig-Hoch; RH stark (→F) |
| Jakob Machura (2015) | 17-1 | G | G | ? | ? | ? | ? | G *(Übergänge zu langsam)* | linkshänder; RH stärker als VH; Koordinations-/Balleinschätzungsschwäche; Beinarbeit fordern |
| Henry Plier (2015) | 17-1 | G(→F) | G | G | G | G | G | G *(Übergänge zu langsam)* | guter Spieler; mental arbeiten (Wut bei Unkonzentration) – fordern; auch Sa 12-E-O |
| Finn Bagdu (2012) | 17-1 | G | G | G | G | – | – | – | älter; Kraft in den Schlägen; Schlagsicherheit steigern |
| Jonathan Röhm (2013) | 17-2 | G *(Anbahnung)* | G *(Anbahnung)* | – | G | – | – | – | spät angefangen → Grobform + Schlagsicherheit erlangen (Ambition ≠ Technikstand) |
| Noam Nebel (2013) | 17-2 | G | G | G | G | – | – | G | Schlagvorbereitung + Ausgangsstellung forcieren |

**→ Saison-Schwerpunkt:** Beinarbeit-Drills integrieren · Schlagvor-/nachbereitung · Schlagsicherheit in Drucksituationen erhöhen · Wettkampf → Taktik einstreuen.

## Saison-Schwerpunkt
> Abgeleitet aus der Standortbestimmung; Anker in Cluster F (Grün). Topspin-Grundlage steht bei den meisten → Feinform + Schlagsicherheit; Jonathan zuerst Grobform.

- **Topspin VH/RH Feinform + Schlagsicherheit** (Cluster F · G-1/G-2/G-4) – Elias VH-Schwungfehler korrigieren; Jonathan Grobform/Anbahnung; Rest überwiegend G(→F)
- **Beinarbeit Großfeld + Schlagvor-/nachbereitung** (Cluster F · G-3/G-5) – „Übergänge zwischen Schlägen" (Jakob/Henry), Drills integrieren
- **Aufschlag-Platzierung** (T/Body/Außen) festigen (Cluster F · AS-T/AS-A) – Jonathan Aufschlag noch „–"
- **Slice RH** Hinführung + **Return aktiv** aufbauen (Cluster F · G-8, TR-T/TR-A) – bei den meisten neu
...
|---|---|---|---|---|---|
| 🔴 | Topspin VH/RH Feinform + Schlagsicherheit | Schwungweg Großfeld, Spin als Druckmittel, Konstanz | F · G-1/G-2 (VH), G-4 (RH) | Topspin-Grobform (Orange) | läuft (T7: reifen lassen, kein Sprung) |
...
- **Elias (jung, ++, Platz 17-1):** VH-Schwungfehler korrigieren (oben→unten → Niedrig-Hoch); RH stark fordern
- **Jakob (linkshänder, Platz 17-1):** RH > VH; Koordination/Balleinschätzung; Beinarbeit (Übergänge zu langsam); **linkshändig** bei Zuspiel/Doppel beachten
- **Henry (guter Spieler, Platz 17-1):** technisch breit; **mental** arbeiten (Wut bei Unkonzentration); taktisch fordern; auch Sa 12-E-O
- **Finn (älter, Platz 17-1):** Kraft da → Schlagsicherheit/Kontrolle; Slice/Return neu; Beinarbeit aufbauen (–)
- **Jonathan (spät angefangen, Platz 17-2):** Topspin-Grobform + Schlagsicherheit zuerst; Aufschlag/Slice/Return/Beinarbeit neu (–); Ambition ≠ Technikstand
- **Noam (Platz 17-2):** Schlagvorbereitung + Ausgangsstellung forcieren; taktisch fordern; Slice/Return neu
