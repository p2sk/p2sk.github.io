...
| 🟠 | Cross/Longline VH+RH steuern | Zielzonen mit Hütchen, Richtung sichern | D · O-3 | Topspin-Grobform | → Saison 2 |
| 🟠 | Splitstep/Beinarbeit | „kleiner Hopser", Positionierung Midcourt, Recovery | D · O-2/O-4 (+ BW) | Grundschläge | → Saison 2 (alle „–") |
| 🟢 | Höhe steuern + Volley situativ | tief/hoch übers Netz, Volley in Spielsituation, Lob als Gegenmittel | D · O-5 / *F-08 offen*, Lob | Topspin-Grobform | → Saison 2 |
| 🟢 | Aufschlag + Return als Spieleröffnung | Punkt aktiv eröffnen (AS + Return als Einheit) | D · AS-G03/04 (TA) + TR-T01, DP-O1 | Aufschlag + Return | → Saison 2 |
| 🟢 | Punktgewinnungs-Taktik | „mein guter Schlag → Druck aufbauen", sicher lang vs. Winkel | D · O-3 (Anwendung), Spielformen | Richtung steuern | → Saison 2 |
| 🟢 | Spielsituation Grundlinie + Beinarbeit | Zuspielhöhe lesen, Positionierung unter Spielbedingungen | D · GL-A / O-2/O-4 | Topspin steuerbar | → Saison 2 |
| 🟢 | Doppel (Grundregeln/Positionen) + Turnierform | Startpositionen, Netzpartner, Mini-Match-Turnier / Cross-Doppel | D · DP-O1/DP-O2, Mini-Match | Aufschlag + Return | → Saison 2 (Saisonabschluss) |
