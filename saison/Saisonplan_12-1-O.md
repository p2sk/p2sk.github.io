...
**Cluster:** D – Orange | **Stufe:** 🟠 Orange (etabliert auf Midcourt, erste taktische Entscheidungen)
**Trainer:** Ben / Jessalyn | **Gruppengröße:** 5 (Anna Böcker, Anouk Weber, Emiliya Siamenava, Luna Huseni, Marie Böcker)
...
**Erhoben:** T1, 16.05.2026 · **Methode:** Freies Spiel + Beobachtung (Midcourt) · Standorte der Fr-Kinder aus 18-2-O/18-3-O übernommen
...
|---|---|---|---|---|---|---|---|
| Anouk Weber | G | G | G | G | – | G | am weitesten (VH+RH-Topspin G) → fordern: RH/Steuerung/Taktik |
...
- **Cross/Longline VH+RH steuern** (Cluster D · O-3) – Zielzonen, Richtungssteuerung sichern
- **Splitstep/Beinarbeit aufbauen** (Cluster D · O-2/O-4) – alle „–", auf Midcourt kalibrieren
- begleitend: Höhe steuern + Volley situativ (O-5 / *F-08 offen*, Lob) · Aufschlag/Return-Spieleröffnung (AS-G03/04 + TR-T01, DP-O1) · Punktgewinnungs-Taktik (O-3 Anwendung) · Doppel + Turnierform (DP-O1/O2, Mini-Match)
...
| 🟠 | Aufschlag von oben festigen | Wurf–Treffpunkt–Schwung, Aufschlagfeld treffen | D · AS-Grobform (AS-G03/04) | Angabe v. unten | offen (alle G → Anwendung steigern) |
| 🟠 | Cross/Longline VH+RH steuern | Zielzonen mit Hütchen, Richtung sichern | D · O-3 | Topspin-Grobform | offen |
| 🟠 | Splitstep/Beinarbeit | „kleiner Hopser", Positionierung Midcourt, Recovery | D · O-2/O-4 (+ BW) | Grundschläge | offen (alle „–") |
| 🟢 | Höhe steuern + Volley situativ | tief/hoch übers Netz, Volley in Spielsituation, Lob als Gegenmittel | D · O-5 / *F-08 offen*, Lob | Topspin-Grobform | offen |
| 🟢 | Aufschlag + Return als Spieleröffnung | Punkt aktiv eröffnen (AS + Return als Einheit) | D · AS-G03/04 (TA) + TR-T01, DP-O1 | Aufschlag + Return | offen |
| 🟢 | Punktgewinnungs-Taktik | „mein guter Schlag → Druck aufbauen", sicher lang vs. Winkel | D · O-3 (Anwendung), Spielformen | Richtung steuern | offen |
| 🟢 | Spielsituation Grundlinie + Beinarbeit | Zuspielhöhe lesen, Positionierung unter Spielbedingungen | D · GL-A / O-2/O-4 | Topspin steuerbar | offen |
| 🟢 | Doppel (Grundregeln/Positionen) + Turnierform | Startpositionen, Netzpartner, Mini-Match-Turnier / Cross-Doppel | D · DP-O1/DP-O2, Mini-Match | Aufschlag + Return | offen (Saisonabschluss) |
...
- T1 16.05. – VH-Topspin Grobform (Niedrig-Hoch, Treffpunkt hüfthoch)
...
- T7 11.07. – **Cross/Longline VH+RH steuern** ([TE_12-1-O_T7](../7-11/TE_12-1-O_T7_Cross-Longline-Steuerung.md): GS-O07 → GS-O09 → GS-O08) → Beobachtung nach der Einheit nachtragen
- T<n> <Datum> – <was lief / Beobachtung> → <Konsequenz: nächstes Thema / wiederholen / einschieben>

## Ausblick Saison 2 / Cluster F
Wenn Topspin-Ansatz (VH/RH) stabil und Aufschlag von oben das Aufschlagfeld trifft → reif für Materialwechsel Grünball / Großfeld (Cluster F, Einstieg aus Orange). Griffwechsel vertiefen, Spielmuster (Angriffsball, Netzübergang), Doppel.
