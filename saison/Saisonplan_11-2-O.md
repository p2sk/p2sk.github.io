...
## Einordnung
- Gruppe im Übergang zu Orange – Materialwechsel Rotball → Orangeball + Midcourt im Fokus; **Cooperation vor Competition**
- Heterogen: oberer Pol (Anna, Paula, Smilla) bereits Orange-Hinführung · **Melija Stonkute** + **Mona Hochmuth** (neu aus 11-1-R, Rot) brauchen Basisarbeit – kein Topspin-/Tempodruck
- Pascal übernimmt nach Sommerferien → Matchmodus (Spielformen, Zählen)
- **Anna De Silva** steht auch in 15-2-RO, **Mona Hochmuth** rotiert mit 15-3-RO → Standorte von dort übernommen; Melija/Paula/Smilla in T1 bestätigen
...
> Hinweis: 6 Zieltechnik-Spalten (statt 2–4), da Einstieg aus Rot zwei Stufen überbrückt.

**Erhoben:** T1, 16.05.2026 · **Methode:** Freies Spiel + Beobachtung (Midcourt-Einstieg) · Anna/Mona aus 15-2-RO/15-3-RO übernommen

| Kind | Grundschläge Midcourt | Ballwechsel | Beinarbeit/Splitstep | VH-Topspin | Aufschlag v. oben | Volley | Abgeleiteter Schwerpunkt |
|---|---|---|---|---|---|---|---|
| Anna De Silva | G | mit Trainer möglich | – | – | – | G | VH-Grobform da; RH-Grobform anbahnen |
| Paula Moral | G | (→) Partner | – | (→) | – | G | Orange-Hinführung; Treffpunkthöhe/Splitstep · T1 bestätigen |
| Smilla Machura | G | (→) Partner | – | (→) | – | G | Orange-Hinführung; Treffpunkthöhe/Splitstep · T1 bestätigen |
| Melija Stonkute | (→) | mit Trainer | – | – | – | G | braucht länger → Cooperation/Treffpunkt/Beinarbeit sichern, kein Topspin-Druck |
| Mona Hochmuth | G | mit Trainer + gute Spieler | – | – | – | G | neu aus Rot; sichere Ballwechsel VH+RH, kein Topspin-Druck (rotiert mit 15-3-RO) |

**→ Saison-Schwerpunkt:** Übergang Rot → Orange; Grundschläge auf Midcourt + sichere Ballwechsel festigen (Melija/Mona Hauptfokus); Orange-Neu (Treffpunkthöhe, Splitstep, Topspin, Aufschlag) behutsam/spät, erst wenn Grundschläge auf Midcourt tragen.

## Saison-Schwerpunkt
> Abgeleitet aus der Standortbestimmung; Anker in Cluster D (Einstieg aus Rot → konsolidieren ← B, Orange-Neu nur behutsam/spät).

- **Grundschläge VH/RH + Balleinschätzung auf Midcourt festigen** (Grobform) (Cluster D: konsolidieren ← Cluster B) – Melija/Mona Hauptfokus; Anna RH anbahnen
- **Ballwechsel mit Trainer → Partner** ausbauen (Cooperation-Rallye) (Cluster D · KT-R13/KT-R18 Midcourt)
- **Volley/Netz festigen** (alle G) (Cluster D · O-5)
- **Treffpunkthöhe + Splitstep erster Einsatz** auf Midcourt (Cluster D · O-2/O-4) – behutsam
- **VH-/RH-Topspin + Aufschlag von oben** nur **späte, leichte Hinführung** (Cluster D · O-1/O-6, AS-Grobform), **ohne Griffwechseldruck** – erst wenn Grundschläge auf Midcourt tragen
...
- **Melija Stonkute:** braucht länger, bleibt bewusst in der Gruppe → mehr Cooperation-Rallyes, Treffpunkt/Beinarbeit sichern, Steigerung erst bei Stabilität, kein Topspin-/Tempodruck
- **Mona Hochmuth (neu aus Rot):** Basisarbeit auf Midcourt – Treffpunkt sichern, sichere Ballwechsel VH+RH, kein Topspin-Druck; rotiert mit 15-3-RO (gute Spieler als Zuspielpartner)
- **Anna De Silva:** VH-Grobform da, RH-Grobform anbahnen
- **Paula + Smilla:** oberer Pol, Orange-Hinführung früher (Treffpunkthöhe/Splitstep); Standort in T1 bestätigen
