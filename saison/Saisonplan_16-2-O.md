...
## Einordnung
- Gruppe im Übergang Rot → Orange, **Reifegrad im Aufbau** – modal noch Rot-Niveau (G). Festigung der Grobform + behutsame Anbahnung der Orange-Elemente, **kein Druck**.
- Niveau-Split: Fabian + Linja (Topspin früh selbstständig) · Aaron (Grobform-Festigung, Grundstellung) · Louis + Phileas (konsolidieren, Topspin/Aufschlag erst anbahnen)
- Stationsbetrieb oder parallele Zuspiele sinnvoll für Niveauunterschiede
- Gruppe spielt teilweise Minicourt + Midcourt-Cup → Spielform/Mini-Match als Pflichtschluss
...
> Hinweis: 5 Zieltechnik-Spalten (statt 2–4) bewusst, da Übergangscluster C zwei Stufen überbrückt.

**Erhoben:** T1, 08.05.2026 · **Methode:** Freies Spiel + Beobachtung (Midcourt-Einstieg)

| Kind | Grundschläge Midcourt | Beinarbeit/Splitstep | VH-Topspin | Aufschlag v. oben | Volley | Abgeleiteter Schwerpunkt |
|---|---|---|---|---|---|---|
| Aaron Akdagcik | G (Rot: G) | – | G | G | G | Grundstellung/Grundlagen teilw. schludrig → Festigung Grobform |
| Fabian Störmann | G (Rot: G) | – | G | G | G | Topspin früh selbstständig, Richtung steuern |
| Linja Rübsteck | G (Rot: G) | – | G | G | G | Topspin früh selbstständig, Richtung steuern |
| Louis Akdagcik | G (Rot: G) | – | – | – (Angabe v. unten) | G | Grundschläge auf Midcourt festigen, weniger Topspin-Druck |
| Phileas Asholt | G (Rot: G) | – | – | – (Angabe v. unten) | – | Konsolidierung + Cooperation-Rallyes, Topspin erst anbahnen |

**→ Saison-Schwerpunkt:** Bei allen Anbahnung VH-/RH-Topspin; Hinführung Aufschlag von oben; erster Einsatz von Split-Step. Gruppe spielt teilweise Minicourt + Midcourt-Cup.

## Saison-Schwerpunkt
> Abgeleitet aus der Standortbestimmung; Anker in Cluster D (Einstieg aus Rot: konsolidieren aus B + neu/Grobform Orange).

- **Grundschläge VH/RH auf Midcourt festigen** (Grobform) (Cluster D: Konsolidierung aus Rot ← Cluster B) – Aaron Grundstellung, Louis/Phileas konsolidieren
- **Splitstep/Beinarbeit erster Einsatz** (Cluster D · O-2/O-4) – alle bei „–", auf Midcourt neu kalibrieren
- **VH-/RH-Topspin Hinführung** (Grobform) (Cluster D · O-1 / O-6) – Fabian/Linja selbstständiger, Louis/Phileas erst anbahnen
- **Aufschlag von oben Hinführung** (Cluster D · AS-Grobform) – Louis/Phileas zuerst Angabe von unten sichern
- **Cross/Longline grob steuern** (Cluster D · O-3)
...
- **Fabian + Linja:** Topspin früh selbstständig → Richtung steuern, über Zielzonen fordern; als Zuspielpartner nutzen
- **Aaron:** Grundstellung/Grundlagen teilw. schludrig → Festigung Grobform, saubere BS
- **Louis:** Grundschläge Midcourt festigen, weniger Topspin-Druck; Aufschlag zuerst Angabe von unten
- **Phileas:** Konsolidierung + Cooperation-Rallyes; Topspin/Volley erst anbahnen
...
- T1 08.05. – (nicht dokumentiert)
- T2 15.05. – (nicht dokumentiert)
