...
## Einordnung
- Kleine Gruppe mit heterogenem Niveau (Orange/Grün bis Gelb-Bereich); Cluster F als Rahmen – Slice, Stoppball, Aufschlag, Return; bei stärkeren Kindern Gelb-Elemente einbauen
- **Viktor Franzen, Louis Köneke, Finn Hanrieder** trainieren zusätzlich freitags in **16-1-G** (Pascal, Gelb-wettkampfnah) → Standorte von dort; **Finn Bagdu** aus **17-1-O** (ambitioniert, Grün)
- **Pascal trainiert auch 16-1-G + 17-1-O** → enge Abstimmung, Standorte direkt übertragbar
- Nach Sommerferien: Match-Fokus, taktische Spielmuster
...
> Hinweis: heterogen Grün→Gelb-Bereich. Standorte aus 16-1-G (Viktor/Louis K./Finn H.) + 17-1-O (Finn Bagdu) übernommen.

**Erhoben:** T1, 16.05.2026 · **Methode:** Freies Spiel + Beobachtung

| Kind | Topspin VH/RH (→F) | Slice RH | Aufschlag-Platzierung | Return aktiv | Beinarbeit/Recovery | Abgeleiteter Schwerpunkt |
|---|---|---|---|---|---|---|
| Louis Köneke | F *(VH Treffpunkt zu nah)* | G(→F) | G(→F) | G | G *(schwach)* | Power da → Kontrolle/Treffpunkt; **Beinarbeit Hauptbaustelle** |
| Finn Hanrieder | G(→F) *(treffunsicher)* | (→)G | G | G | G | Grundschläge Feinform-Übergang konsolidieren; Treffgenauigkeit |
| Viktor Franzen | G(→F) *(treffunsicher)* | – | G | G | G | Treffgenauigkeit → Feinform; Slice **neu**; taktisch fordern |
| Finn Bagdu (2012) | G (VH+RH) | – | G | – | – | älter, Kraft in den Schlägen → Schlagsicherheit; Slice/Return neu; Beinarbeit aufbauen |

**→ Saison-Schwerpunkt:** Feinform Grundschläge/Topspin + Schlagsicherheit über Beinarbeit; Slice (RH→VH) + Stoppball aufbauen; Aufschlag-Platzierung festigen; Return aktiv (Technik → Anwendung); taktische Spielmuster + Match; stärkere Kinder Gelb-Elemente dosiert.

## Saison-Schwerpunkt
> Abgeleitet aus der Standortbestimmung; Anker in Cluster F (Grün). Heterogen → Differenzierung; Gelb-Reach für Stärkere (Anker Cluster H), transparent gemischt.

- **Slice RH → VH + Stoppball aufbauen** (Grobform→Feinform) (Cluster F · G-8 RH, *F-06 VH offen*, GL-T06 Stoppball) – Viktor/Finn B. neu, Finn H. (→)G, Louis K. G(→F)
- **Topspin VH/RH Feinform + Schlagsicherheit** (Cluster F · G-1/G-2 VH, G-4 RH) – alle (→F); Treffgenauigkeit (Finn H./Viktor), Louis K. VH-Treffpunkt
- **Beinarbeit/Recovery → Schlagsicherheit** (Cluster F · G-3/G-5 + SN/AU) – Louis K. + Finn B. Hauptbaustelle
- **Aufschlag-Platzierung festigen** (T/Body/Außen) (Cluster F · AS-T/AS-A) – alle G
- **Return aktiv (Technik → Anwendung Trading/Building)** (Cluster F · TR-T01/T02 → TR-A01/A02 🎯)
- **Chip and Charge + Netzübergang** (Cluster F · TR-A05, G-6/NP-T01/02→NP-A01)
...
- **Viktor Franzen:** Treffgenauigkeit Topspin (G→F); Slice **neu** von 0 aufbauen; taktisch fordern; Beinarbeit
- **Finn Bagdu (älter, aus 17-1-O):** Kraft da → Schlagsicherheit/Kontrolle; Slice/Return neu; Beinarbeit aufbauen (–)
- **Heterogen:** stärkere Kinder früher in Spielmuster + Gelb-Drucksituationen; schwächere Slice-Bewegung länger begleiten
...
- T2 23.05. – Slice Vorhand (Übergang Grundlinie → Netz)
- T3 30.05. – Slice in der Rallye (Topspin ↔ Slice situativ wechseln)
