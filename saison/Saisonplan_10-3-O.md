...
- **Niveau-/Platzverbund mit 10-2-O → Rotation nach Anwesenheit** (je nach Teilnehmerzahl gemeinsam/rotierend)
- Kleingruppe: individuelles Zuspiel und Anpassung an Lerntempo möglich
...
|---|---|---|---|---|---|---|---|
| Janno Kaczmarek | G | mit Trainer | – | – | – | G | etwas jünger; Grobform vorhanden; Anbahnung weiterer Schläge möglich |
...
- **Grundschläge Midcourt + Balleinschätzung festigen** (Grobform) (Cluster D: konsolidieren ← B) – Malia Hauptfokus
...
- **VH-Topspin + Aufschlag von oben** nur **späte, leichte Hinführung** (Cluster D · O-1, AS-Grobform) – erst wenn Grundschläge tragen (Topspin nur, wenn Treffpunkthöhe sitzt)
...
- **Janno (etwas jünger):** Grobform da → Anbahnung weiterer Schläge möglich
